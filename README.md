...
<p align="center">
  <a href="https://labex.io/courses/building-custom-security-tools">
    <img src="https://course-cover.labex.io/building-custom-security-tools.png" alt="Building Custom Security Tools">
  </a>
</p>
...
[Start Course on LabEx](https://labex.io/courses/building-custom-security-tools)

## Exercises

|   Index | Name                              | Difficulty   | Practice                                                                                                                                                 |
|---------|-----------------------------------|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
|       1 | Building a Port Scanner           | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-building-a-port-scanner-656213?course=building-custom-security-tools'>Start Lab</a>                 |
|       2 | Crafting Packets with Scapy       | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-crafting-packets-with-scapy-656214?course=building-custom-security-tools'>Start Lab</a>             |
|       3 | Building a Directory Fuzzer       | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-building-a-directory-fuzzer-656212?course=building-custom-security-tools'>Start Lab</a>             |
|       4 | Custom Tool Development Challenge | Intermediate | <a target='_blank' href='https://labex.io/labs/linux-custom-tool-development-challenge-656211?course=building-custom-security-tools'>Start Challenge</a> |
